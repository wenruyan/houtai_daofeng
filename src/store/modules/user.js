...
const user = {
  ...
  mutations: {
    ...
    //   state.menuAll = menuAll;
    // },
    CHANGE_USERINFO_CARD: (state, val) => {
      state.userInfoCardShow = val;
      localStorage.setItem('userInfoCard', val);
    },
    CHANGE_NAV_TOP: (state, val) => {
      state.topNav = val;
      localStorage.setItem('topNav', val);
    },
    CHANGE_SELECTED_THEME: (state, val) => {
      state.selectedTheme = val;
      localStorage.setItem('selectedTheme', JSON.stringify(val));
    },
    CHANGE_HEADER_FIXED: (state, val) => {
      state.headerFixed = val;
      localStorage.setItem('headerFixed', val);
    },
    CHANGE_SIDER_FIXED: (state, val) => {
      state.siderFixed = val;
      localStorage.setItem('siderFixed', val);
    },
    CHANGE_SIDER_ICON: (state, val) => {
      state.siderIconShow = val;
      localStorage.setItem('siderIcon', val);
    },
    CHANGE_EN: (state, val) => {
      state.en = val;
